...
void modity(List *p)
{
    ...
    switch(option)
    {
        case '1': scanf_s("%s", name);   strcpy_s(p->member.name,48,name);               break;
		case '2': scanf_s("%s", id);     strcpy_s(p->member.student_number,10,id);       break;
		case '3': scanf_s("%s", sex);    strcpy_s(p->member.sex,16,sex);                 break;
		case '4': scanf_s("%f", &score); p->member.advanced_mathematics = score;         break;
		case '5': scanf_s("%f", &score); p->member.college_english = score;              break;
		case '6': scanf_s("%f", &score); p->member.C_language = score;                   break;
		case '7': scanf_s("%f", &score); p->member.computer_introductory_theory = score; break;
    }
    if(option>'3'){
